...
@section('content')
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            <div class="flex-none">
                <img src="images/rdr2.png" alt="rdr" class="w-68 h-72">
            </div>
            <div class="lg:ml-12 mt-2 lg:mt-0">
                ...
                <div class="flex flex-wrap items-center mt-8 lg:mr-64">
                    ...
                    <div class="mt-12">
                        <p>Red Dead Redemption 2 (stylized as Red Dead Redemption II) is a 2018 action-adventure game developed and published by Rockstar Games. The game is the third entry in the Red Dead series and is a prequel to the 2010 game Red Dead Redemption.</p>
                    </div>
                    <div class="mt-6">
        ...
        <div class="images-container border-b border-gray-800 pb-12 mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
                <div>
                    <a href="#">
                        <img src="images/rdr2-1.jpg" alt="" class="hover:opacity-75 transition duration-150 ease-in-out">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="images/rdr2-2.jpg" alt="" class="hover:opacity-75 transition duration-150 ease-in-out">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="images/rdr2-3.jpg" alt="" class="hover:opacity-75 transition duration-150 ease-in-out">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="images/rdr2-4.jpg" alt="" class="hover:opacity-75 transition duration-150 ease-in-out">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="images/rdr2-5.jpg" alt="" class="hover:opacity-75 transition duration-150 ease-in-out">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="images/rdr2-6.jpg" alt="" class="hover:opacity-75 transition duration-150 ease-in-out">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="similar-games container text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12">
                <div class="game mt-8 items-center">
                    <div class="relative inline-block">
                        <a href="#">
                            <img src="images/pubg.jpg" alt="pubg" class="hover:opacity-75 transition duration-150 ease-in-out ">
                        </a>
                    ...
                    <div class="text-gray-400 mt-1">Personal Computer</div>
                </div>
                <div class="game mt-8 items-center">
                    <div class="relative inline-block">
                        <a href="#">
